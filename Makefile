...
main.o: main.cpp src/components.hpp
...
bin/main-module.o: src/main-module/odyssey.h src/main-module/odyssey.cpp src/components.hpp
	g++ -lstdc++ -c -o bin/main-module.o src/main-module/odyssey.cpp

bin/time-module.o: src/time-module/chrono.h src/time-module/chrono.cpp src/time-module/chronoCl.h src/components.hpp
	g++ -lstdc++ -c -o bin/time-module.o src/time-module/chrono.cpp

bin/view-module.o: src/view-module/opengl.cpp src/view-module/opengl.hpp src/view-module/view.h src/view-module/viewHidden.h src/view-module/classes.hpp src/view-module/frame.hpp src/view-module/loader.hpp src/components.hpp
